...
Source files for this diagram are available [here](https://github.com/AerospaceJam/docs/blob/main/docs/challenges/ir/receiver.fzz)
...
Source files for this diagram are available [here](https://github.com/AerospaceJam/docs/blob/main/docs/challenges/ir/transmitter.fzz)
